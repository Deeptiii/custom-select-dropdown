export default class Select {
    ...
    selectValue(value) {
        ...
        const prevSelctedOption = this.selectedOption
        prevSelctedOption.selected = false;
        prevSelctedOption.element.selected = false
        ...
        this.optionCustomElement
            .querySelector(`[data-value="${prevSelctedOption.value}"]`)
